            ...
            <div class="row g-3">
                ...
                <div class="col-12 mt-2">
                    ...
                    <small class="text-muted">
                        Hanya menampilkan kelas angkatan {{ $mahasiswa->angkatan }}
                    </small>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check border rounded-3 p-2
                                {{ $mahasiswa->kelas->contains($k->id) ? 'border-danger bg-light' : '' }}">
                                ...
                                <label class="form-check-label fw-bold"
                                    ...
                                    <div class="text-muted small">
                                        Angkatan {{ $k->angkatan }} · Semester {{ $k->semester }}
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="alert alert-warning">
                                Tidak ada kelas untuk angkatan {{ $mahasiswa->angkatan }}.
